    ...
    <>
      <nav className="navbar">
        ...
        <div className='menu-icon'  onClick={handelClick}>
            ...
            {button && <Button buttonSize='btn--outline' onClick={() => setActivModal(true)}>Записаться на прием </Button>} 
            <Form active={activModal} setActive={setActivModal}/>
        </div>
        ...
        <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                ...
                <li className='nav-item'>
                    <button className={click ? 'btn-mobile active' : 'btn-mobile'} onClick={() => setActivModal(true)}>Записаться на прием</button>
                    <Form active={activModal} setActive={setActivModal}/>
                </li>
            </ul>
        </div>
